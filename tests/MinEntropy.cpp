...
TYPED_TEST_P(MinEntropyTest, Vulnerability) {
	...
	EXPECT_PRED2(equal2<eT>, eT(5)/10, MinEntropy<eT>().vulnerability(t.unif_2));
	EXPECT_PRED2(equal2<eT>, eT(1)/10, MinEntropy<eT>().vulnerability(t.unif_10));
	EXPECT_PRED2(equal2<eT>, 1,            MinEntropy<eT>().vulnerability(t.dirac_4));
	EXPECT_PRED2(equal2<eT>, eT(8)/10, MinEntropy<eT>().vulnerability(t.pi1));
}
...
TYPED_TEST_P(MinEntropyTest, Cond_vulnerability) {
	...
	EXPECT_PRED2(equal2<eT>, 1,        MinEntropy<eT>(t.id_2).cond_vulnerability(t.unif_2));
	EXPECT_PRED2(equal2<eT>, 1,        MinEntropy<eT>(t.id_2).cond_vulnerability(t.dirac_2));
	EXPECT_PRED2(equal2<eT>, 1,        MinEntropy<eT>(t.id_2).cond_vulnerability(t.pi1));
	
	EXPECT_PRED2(equal2<eT>, 1,        MinEntropy<eT>(t.id_10).cond_vulnerability(t.unif_10));
	EXPECT_PRED2(equal2<eT>, 1,        MinEntropy<eT>(t.id_10).cond_vulnerability(t.dirac_10));
	EXPECT_PRED2(equal2<eT>, 1,        MinEntropy<eT>(t.id_10).cond_vulnerability(t.pi2));
	
	EXPECT_PRED2(equal2<eT>, eT(1)/10, MinEntropy<eT>(t.noint_10).cond_vulnerability(t.unif_10));
	EXPECT_PRED2(equal2<eT>, 1,        MinEntropy<eT>(t.noint_10).cond_vulnerability(t.dirac_10));

	EXPECT_PRED2(equal2<eT>, MinEntropy<eT>().vulnerability(t.pi2), MinEntropy<eT>(t.noint_10).cond_vulnerability(t.pi2));

	EXPECT_PRED2(equal2<eT>, MinEntropy<eT>().vulnerability(t.pi3), MinEntropy<eT>(t.c1).cond_vulnerability(t.pi3));	// no change in vulnerability
	EXPECT_PRED2(equal2<eT>, eT(31)/40, MinEntropy<eT>(t.c1).cond_vulnerability(t.pi4));
...
TYPED_TEST_P(MinEntropyTest, Max_mult_leakage) {
	...
	EXPECT_PRED2(equal2<eT>, 2,         MinEntropy<eT>(t.id_2).max_mult_leakage());
	EXPECT_PRED2(equal2<eT>, 10,        MinEntropy<eT>(t.id_10).max_mult_leakage());
	EXPECT_PRED2(equal2<eT>, 1,         MinEntropy<eT>(t.noint_10).max_mult_leakage());
	EXPECT_PRED2(equal2<eT>, eT(15)/10, MinEntropy<eT>(t.c1).max_mult_leakage());

	EXPECT_PRED2(equal2<eT>, MinEntropy<eT>(t.crand_10).mult_leakage(t.unif_10), MinEntropy<eT>(t.crand_10).max_mult_leakage()); // max_mult_leakage is given for uniform prior
}
...
TYPED_TEST_P(MinEntropyTestReals, Cond_entropy) {
	...
	EXPECT_PRED2(equal2<eT>, 0,   MinEntropy<eT>(t.id_2).cond_entropy(t.unif_2));
	EXPECT_PRED2(equal2<eT>, 0,   MinEntropy<eT>(t.id_2).cond_entropy(t.dirac_2));
	EXPECT_PRED2(equal2<eT>, 0,   MinEntropy<eT>(t.id_2).cond_entropy(t.pi1));
	
	EXPECT_PRED2(equal2<eT>, 0,   MinEntropy<eT>(t.id_10).cond_entropy(t.unif_10));
