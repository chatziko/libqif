...
TYPED_TEST_P(MetricTestReals, Mult_kantorovich) {
	...
	EXPECT_PRED_FORMAT2(equal2<eT>, eT(7.1560446514326657), mkant_euclid(t.unif_10,  t.dirac_10));
	EXPECT_PRED_FORMAT2(equal2<eT>, eT(7.1560446514326657), mkant_euclid(t.dirac_10, t.unif_10));
