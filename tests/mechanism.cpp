...
REGISTER_TYPED_TEST_SUITE_P(MechTest, Is_private, Smallest_epsilon, Reals, Discrete, Grid);

INSTANTIATE_TYPED_TEST_SUITE_P(Mech, MechTest, NativeTypes);
