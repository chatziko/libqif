...
TYPED_TEST_P(MechDPrivTest, OptExpLoss) {
	...
	Chan<eT> geom = geometric<eT>(size, epsilon * step);
	Chan<eT> opt = opt_exp_loss<eT>(t.unif_10, size, epsilon * d, bin_loss);
	Chan<eT> dist_opt = opt_exp_loss<eT>(t.unif_10, size, epsilon * d, bin_loss, "dist");
	Chan<eT> dist_opt2 = opt_exp_loss<eT>(t.unif_10, size, epsilon * d, bin_loss, "dist_strict");
	...
	opt = opt_exp_loss<eT>(t.unif_10, size, epsilon * d, bin_loss);
