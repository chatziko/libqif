...
TYPED_TEST_P(GuessingTest, Vulnerability) {
	...
	EXPECT_PRED_FORMAT2(equal2<eT>, eT(1),     guessing::prior(t.point_4));
...
TYPED_TEST_P(GuessingTest, Post_entropy) {
	...
	EXPECT_PRED_FORMAT2(equal2<eT>, eT(1),    guessing::posterior(t.point_2, t.id_2));
	...
	EXPECT_PRED_FORMAT2(equal2<eT>, eT(1),    guessing::posterior(t.point_10, t.id_10));
	...
	EXPECT_PRED_FORMAT2(equal2<eT>, eT(1),     guessing::posterior(t.point_10, t.noint_10));
